...
import com.novafinance.feature.goals.GoalsRoute
import javax.inject.Inject

class GoalsNavGraphProvider @Inject constructor() : NovaNavGraphProvider {

    override val startRoute: String = NovaRoutes.GOALS

    override fun registerGraph(builder: NavGraphBuilder, navController: NavController) {
        builder.composable(startRoute) {
            GoalsRoute(onBack = { navController.popBackStack() })
        }
    }
}
